...
export default function GroupBlock() {
  ...
  const [layoutDirection] = useLiquid<string>("block.settings.layout_direction");

  return (
    <div className={`ssg-group ${layoutDirection}`} style={{ padding: `${padding}px 0`, alignItems: alignment }}>
      <BlockSlot />
    </div>
  );
}
